...
# Ollama Tool Tester Beta | v0.0.1
# =============================================================================

# =============================================================================
# METADADOS DO PROJETO
# =============================================================================
PROJECT_NAME="Ollama Tool Tester Beta"
VERSION="v0.0.1"
...
SCRIPT_NAME="ollama-tool-tester-beta-${VERSION}.sh"
RELEASE_DATE="2026-02-21"

DESCRIPTION="Script beta para validação de Function Calling (Tools) em modelos
locais do Ollama. Essencial para integração com frameworks como OpenClaw.
...
COUNTER=1
RESULTS_FILE="${RESULTS_DIR}/tools_test_beta_${VERSION}_${TIMESTAMP}.csv"
while [ -f "$RESULTS_FILE" ]; do
    RESULTS_FILE="${RESULTS_DIR}/tools_test_beta_${VERSION}_${TIMESTAMP}_${COUNTER}.csv"
    COUNTER=$((COUNTER + 1))
done
...
echo "║         Ollama Tool Tester Beta - Relatório de Sistema                   ║"
echo "╚══════════════════════════════════════════════════════════════════════════╝"
echo ""
...
for model in "${MODELS_ARRAY[@]}"; do
    ...
    # LIMPEZA DE CACHE A CADA 3 MODELOS
...
echo "" | tee -a "$LOG_FILE"
echo "═══════════════════════════════════════════════════════════════════════════" | tee -a "$LOG_FILE"
echo -e "${SAB_GREEN}✅ TESTE DE FUNCTION CALLING CONCLUÍDO COM SUCESSO!${NC}" | tee -a "$LOG_FILE"
